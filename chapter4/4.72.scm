...
;Interleaving is the ideal solution for this scenario because despite the infinite nature of the first stream, we can now observe the evaluation results of both clauses.
