...
;When computing fib for n=2, add-streams computes fibs for n=0 and n=1 in which case (add-strems [fib 0] [fib 1]) is memoized.
;When computing fib for n=3, add-streams computes fibs for n=1 and n=2 in which case (add-strems [fib 1] [fib 2]) is memoized.
;(But notice here that [fib 2] doesn't spawn another level of execution since it's result is memoized.)
;When computing fib for n=4, add-streams computes fibs for n=2 and n=3 in which case (add-strems [fib 2] [fib 3]) is memoized.
