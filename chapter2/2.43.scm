...
; The above sequence runs slowly than the one in 2.42 because while calculating queens at column k, the queens for column (k-1) is calculated (k-1) times during the process of generating an extended set of positions.
